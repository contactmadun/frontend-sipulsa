        ...
        <div class="row">
            <div class="col-12 col-lg-3 col-navbar d-none d-xl-block">
                <aside class="sidebar">
                    ...
                    <h5 class="sidebar-title text-start">Daily Use</h5>

                    <router-link to="/admin" :class="linkBeranda">
                    ...
                    <router-link to="/users" :class="linkInformasiPengguna">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <router-link to="/product" :class="linkProductMarketplace">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
...
export default {
    ...
    props:{
        linkBeranda: String,
        linkInformasiPengguna: String,
        linkProductMarketplace: String,
    }
}
</script>
